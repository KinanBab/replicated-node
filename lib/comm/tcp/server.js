...
Server.prototype._accept = function (connection) {
  ...
  connection.on('pong', function (data) { console.log('pong', data.toString()); });
...
server.on('close', function () { console.log('close', ...arguments); });
server.on('connect', function () { console.log('connect', ...arguments); });
server.on('receiveString', console.log);
server.on('receiveBuffer', console.log);
server.listen();
*/
